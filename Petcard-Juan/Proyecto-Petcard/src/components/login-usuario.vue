  ...
  <div class="container">
    ...
    <div class="right-panel">
      ...
      <div class="form-wrapper">
        ...
        <p
          class="admin-access"
          style="margin-top: 1rem; text-align: center; font-size: 0.9rem;"
        >
          <a
            href="javascript:void(0)"
            @click="irALoginAdmin"
            style="color: #764ba2; font-weight: 600; text-decoration: none;"
          >
...
.left-panel {
  ...
  background-image: url('https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=1200&q=80');
