...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-08-2026 a las 16:54:58
...
--
ALTER TABLE `carnetvacunas`
  MODIFY `ID_carnetVacunas` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único del registro de vacunación.', AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `cita`
--
ALTER TABLE `cita`
  MODIFY `ID_cita` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único de la cita.', AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT de la tabla `cliente`
--
ALTER TABLE `cliente`
  MODIFY `ID_cliente` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único del cliente.', AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `mascota`
--
ALTER TABLE `mascota`
  MODIFY `ID_mascota` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único de la mascota.', AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `notificacion`
--
ALTER TABLE `notificacion`
  MODIFY `ID_notificacion` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único de la notificación.', AUTO_INCREMENT=22;
